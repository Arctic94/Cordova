      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        if (value.label !== void 0) {
          if ((!this.options.limitMin || value >= this.minValue) && (!this.options.limitMax || value <= this.maxValue)) {
            ...
            this.ctx.fillText("hola", 0, -radius - this.lineWidth / 2);
          ...
          if ((!this.options.limitMin || value >= this.minValue) && (!this.options.limitMax || value <= this.maxValue)) {
            ...
            this.ctx.rotate(rotationAngle);
            if(j==0){
              this.ctx.fillText("Agravamiento", 0, -radius - this.lineWidth / 2);
            }
            if(j==1){
              this.ctx.fillText("Poco avance", 0, -radius - this.lineWidth / 2);
            }
            if(j==2){
              this.ctx.fillText("Mejora constante", 0, -radius - this.lineWidth / 2);
            }
            //this.ctx.fillText("hola", 0, -radius - this.lineWidth / 2);
            this.ctx.rotate(-rotationAngle);
          }
