function l1() {
    ...
    localStorage.setItem("dinamica", "Ordenar oración");
    function preload() {
        ...
        this.load.spritesheet('texto', '../www/texturas/l1/ordenar-oracion-01.png');
        ...
        /// this.load.image('star', 'texturas/sprites/star.gif');
        this.load.spritesheet('tarjeta1', '../www/texturas/l1/tarjetas01.png', 279, 336);
    ...
    function create() {
        ...
        //texto.scale.x=0.75;
        //texto.scale.y=0.75;
        tarjeta1 = game.add.sprite(game.world.centerX + 150, game.world.centerY - 200, 'tarjeta1');
        tarjeta1.anchor.set(0.5);
        tarjeta1.scale.x = 0.7;
        tarjeta1.scale.y = 0.7;
        tarjeta2 = game.add.sprite(game.world.centerX - 150, game.world.centerY - 200, 'tarjeta1');
        tarjeta2.anchor.set(0.5);
        tarjeta2.frame = 1;
        tarjeta2.scale.x = 0.7;
        tarjeta2.scale.y = 0.7;
        tarjeta1.inputEnabled = true;
        tarjeta1.input.enableDrag(false);
        tarjeta2.inputEnabled = true;
        tarjeta2.input.enableDrag(false);
